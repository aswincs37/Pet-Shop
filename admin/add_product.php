    ...
    <center>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <select name="cat">
                ...
                $q = "select * from category where cat_id=3";
            ...
            <table>
                ...
                <tr>
                    <td>Product For:</td>
                    <td><input type="radio" name="radio" value="animal"> Animal
                    <input type="radio" name="radio" value="bird"> Bird </td>
                </tr>
                <tr>
                    <td>Product Description :</td>
                    <td><input type="text" name="desc" placeholder="Product Description"></td>
                </tr>
...
if (isset($_POST['add'])) {
    ...
    $q = "INSERT INTO product (cat_id, name, type,description, price, image, date, stock) 
          VALUES ('$category','$pname', '$type','$desc', '$price', '$img', NOW(), '$stock')";
