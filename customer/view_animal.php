...
<body>
    ...
    if (!empty($_GET['animal_id'])) {
        ...
        $pid = $_GET['animal_id'];
        $q = "SELECT * FROM animal where animal_id='$pid'";
                ...
                <div class="container main">
                    ...
                    <div class="product-details">
                        ...
                        if ($row['stock'] == 0) {
                            ...
                            echo '<a href="buynow.php?product_id=' . $row['animal_id'] . '&cat_id=' . $row['cat_id']. '" class="btn btn-primary" style="text-decoration:none;">Buy Now</a>';
