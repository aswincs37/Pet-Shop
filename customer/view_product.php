                ...
                <div class="container main">
                    ...
                    <div class="product-details">
                        ...
                        if ($row['stock'] == 0) {
                            ...
                            echo '<a href="buynow_products.php?product_id=' . $row['product_id'] . '" class="btn btn-primary" style="text-decoration:none;">Buy Now</a>';

                        }
                        echo "<br><br>";
                        echo '<input type="submit" name="submit" class="btn btn-danger" value="Add to Wishlist">';
                        ?>
                    </div>
                </div>
            </form>
