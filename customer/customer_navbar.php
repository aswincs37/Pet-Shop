    ...
    <div class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse ml-auto" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="btn btn-success" href="products.php">Food Products</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-success" href="animal.php">Animals</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-success" href="bird.php">Birds</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMyOrders">
                        <a class="dropdown-item" href="my_products.php">Products</a>
                        <a class="dropdown-item" href="my_orders.php">Animal/Birds</a>
                    </div>
                </li>
