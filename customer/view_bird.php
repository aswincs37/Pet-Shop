...
<body>
    ...
    if (!empty($_GET['bird_id'])) {
        $customer_id = isset($_SESSION['cid']) ? $_SESSION['cid'] : null;
        $pid = $_GET['bird_id'];
        $q = "SELECT * FROM bird where bird_id='$pid'";
            ...
            <form method="post" action="">
                <div class="container main">
                    ...
                    <div class="product-details">
                        ...
                        <input type="hidden" name="product_id" value="<?php echo $row['bird_id']; ?>">
                        ...
                        if ($row['stock'] == 0) {
                            ...
                            echo '<a href="buynow.php?product_id=' . $row['bird_id'] . '&cat_id=' . $row['cat_id']. '" class="btn btn-primary" style="text-decoration:none;">Buy Now</a>';
