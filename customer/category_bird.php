...
<body>
    ...
    if (!empty($_GET['cat_id'])) {
        ...
        $cid = $_GET['cat_id'];
        $q = "SELECT * FROM bird where cat_id='2'";
                ...
                <div class="container main">
                    ...
                    <div class="product-details">
                        ...
                        if ($row['stock'] == 0) {
                            ...
                            echo '<a href="buynow.php?product_id=' . $row['bird_id'] . '&cat_id=' . $_GET['cat_id']. '" class="btn btn-primary" style="text-decoration:none;">Buy Now</a>';
